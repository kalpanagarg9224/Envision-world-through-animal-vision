...
import com.kalpana.animalVision.fragment.*
import com.google.android.material.navigation.NavigationView
import com.kalpana.animalVision.liveActivity
...
class DashboardActivity : AppCompatActivity() {
    ...
    private fun setToolBar() {
        ...
        supportActionBar?.title = "Animal Vision"
...
private fun openLiveCamera(){
    ...
    supportActionBar?.title =
        "Animal Vision"
    navigationView.setCheckedItem(R.id.livecamera)
